export const courseLessons = [
  {
    ...
    vocabulary: [
      ['Hei', 'Salut', 'Hei! Hvordan har du det?'], ['Takk', 'Mulțumesc', 'Bra, takk.'], ['Jeg heter', 'Mă numesc', 'Jeg heter Anna.'],
      ['Hvordan', 'Cum', 'Hvordan går det?'], ['Bra', 'Bine', 'Jeg har det bra.'], ['Hyggelig', 'Încântat / plăcut', 'Hyggelig å møte deg!'],
    ],
  ...
  },
  {
    ...
    vocabulary: [['Kaffe','Cafea','En kaffe, takk.'],['Melk','Lapte','Vil du ha melk?'],['Brød','Pâine','Jeg vil ha brød.'],['Å bestille','A comanda','Jeg vil bestille.'],['Kroner','Coroane','Det koster 50 kroner.'],['Ha en fin dag','Să ai o zi frumoasă','Takk, ha en fin dag!']],
  ...
  },
  {
    ...
    vocabulary:[['Butikk','Magazin','Jeg går til butikken.'],['Unnskyld','Scuzați-mă','Unnskyld, hvor er melken?'],['Kvittering','Bon / chitanță','Vil du ha kvittering?'],['Handlekurv','Coș de cumpărături','Varene er i handlekurven.'],['Hvor mye','Cât','Hvor mye koster det?'],['Kort','Card','Jeg betaler med kort.']],
  ...
  },
  {
    ...
    vocabulary:[['Hjemme','Acasă','Jeg er hjemme.'],['Å stå opp','A se trezi','Jeg står opp klokka sju.'],['Frokost','Mic dejun','Jeg spiser frokost.'],['Middag','Cină','Jeg lager middag.'],['Leilighet','Apartament','Jeg bor i en leilighet.'],['God natt','Noapte bună','God natt!']],
  ...
  },
  {
    ...
    vocabulary:[['Jobb','Serviciu','Jeg er på jobb.'],['Kollega','Coleg','Hun er min kollega.'],['Møte','Întâlnire','Møtet er klokka ti.'],['Sjef','Șef','Sjefen er på kontoret.'],['Å sende','A trimite','Kan du sende e-posten?'],['Helg','Weekend','Ha en fin helg!']],
